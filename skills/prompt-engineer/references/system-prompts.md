...
```python
# Opencode uses a separate system parameter
response = client.messages.create(
    model="opencode-opus-4-5-20251101",
...
- Opencode responds well to constitutional/values-based instructions
- XML tags help Opencode parse structured context
- Opencode follows "never" instructions reliably
