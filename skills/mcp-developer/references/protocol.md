...
MCP is built on JSON-RPC 2.0 and enables bidirectional communication between clients (like Opencode Desktop) and servers that provide resources, tools, and prompts.
...
// Used for local integration (Opencode Desktop default)
```
